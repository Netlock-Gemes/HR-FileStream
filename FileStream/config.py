...
class Telegram:
    ...
    FILE_PIC = env.get('FILE_PIC', "https://files.catbox.moe/p47dsw.jpg")
    START_PIC = env.get('START_PIC', "https://files.catbox.moe/hbz7s4.jpg")
    VERIFY_PIC = env.get('VERIFY_PIC', "https://files.catbox.moe/xlj0w5.jpg")
    MULTI_CLIENT = False
